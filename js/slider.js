...
let movies = [
   {
     src: "./img/eron1.jpg",
     name: "ERON",
     target: "./artisti/eron.html"

   },
   {
     src: "./img/blatta1.jpg",
     name: "BLATTA",
     target: "./artisti/blatta.html"
   },
 
   {
     src: "./img/burla1.jpg",
     name: "BURLA",
     target: "./artisti/burla.html"
   },
 
   {
     src: "./img/mozone1.jpg",
     name: "MOZONE",
     target: "./artisti/mozone.html"
   },
   {
     src: "./img/default1.jpg",
     name: "DEFAULT",
     target: "./artisti/default.html"
   }
 ];
...
function populateSlider() {
  movies.forEach((image) => {
    ...
    img.src = image.src;
    let name = clone.querySelector(".movie-name");
    name.innerHTML = '<h3>'+ image.name +'</h3>';
    name.href = image.target
